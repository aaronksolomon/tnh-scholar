...
def get_transcript(url: str, lang: str = 'en', download_dir: Path = DEFAULT_TRANSCRIPT_DIR, keep_transcript_file: bool = False) -> str:
...
# def _download_yt_ttml(temp_storage_path: Path, video_url: str, lang: str = 'en') -> Path:   
#     """
#     Downloads video transcript in TTML format to specified path.
...
#         # TTML file will be named: video_id.lang.ttml
#         ttml_file = temp_storage_path / f"{video_id}.{lang}.ttml"
