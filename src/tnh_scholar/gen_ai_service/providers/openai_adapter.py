...
class OpenAIAdapter:
    ...
    def to_openai_request(self, req: ProviderRequest) -> OpenAIChatCompletionRequest:
        ...
        profile = get_model_info(req.provider, req.model).request_profile
        effort = profile.resolve_reasoning(req.reasoning_effort, model=req.model)
        return OpenAIChatCompletionRequest(
            model=req.model,
            messages=messages,
            temperature=profile.resolve_temperature(req.temperature, effort=effort),
