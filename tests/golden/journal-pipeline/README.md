...
These files are generated by running the pipeline and committed as reference outputs.
They are not yet present — see the pipeline walkthrough documentation for commands.
