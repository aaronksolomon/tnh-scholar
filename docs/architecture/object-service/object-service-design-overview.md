...
This document provides a high-level introduction to the Object-Service design pattern used throughout TNH Scholar. For complete architectural details, see [ADR-OS01: Object-Service Design Architecture V3](/architecture/object-service/adr/adr-os01-object-service-architecture-v3.md).
...
See [object-service-implementation-status.md](/architecture/object-service/object-service-implementation-status.md) for current gaps, resolved items, and planned work.

## Related Documentation

- [ADR-OS01: Object-Service Design Architecture V3](/architecture/object-service/adr/adr-os01-object-service-architecture-v3.md) - Complete architectural specification
- [Implementation Status](/architecture/object-service/object-service-implementation-status.md) - Gaps analysis and progress
...
For complete examples, templates, and detailed patterns, see [ADR-OS01](/architecture/object-service/adr/adr-os01-object-service-architecture-v3.md).
