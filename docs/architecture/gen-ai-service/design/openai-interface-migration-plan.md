...
**ADR**: [ADR-A13: Legacy Client Migration](/architecture/gen-ai-service/adr/adr-a13-migrate-openai-to-genaiservice.md)
...
- **Full ADR**: [ADR-A13-legacy-client-migration.md](/architecture/gen-ai-service/adr/adr-a13-migrate-openai-to-genaiservice.md)
- **GenAIService docs**: [ADR-A01-domain-service.md](/architecture/gen-ai-service/adr/adr-a01-object-service-genai.md)
- **Pattern Catalog**: [ADR-A02-pattern-catalog-v1.md](/architecture/gen-ai-service/adr/adr-a02-patterncatalog-integration-v1.md)
