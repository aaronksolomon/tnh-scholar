...
- **Full ADR**: [ADR-A13-legacy-client-migration.md](../../architecture/gen-ai-service/adr/adr-a13-legacy-client-migration.md)
- **GenAIService docs**: [ADR-A01-domain-service.md](../../architecture/gen-ai-service/adr/adr-a01-domain-service.md)
- **Pattern Catalog**: [ADR-A02-pattern-catalog-v1.md](../../architecture/gen-ai-service/adr/adr-a02-pattern-catalog-v1.md)
- **Example usage**: `tests/gen_ai_service/test_service.py`
- **TODO tracking**: [TODO.md](../../TODO.md#5--unify-openai-clients)
