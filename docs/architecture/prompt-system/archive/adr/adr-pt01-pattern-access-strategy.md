---
title: "ADR-PT01: Pattern Access Strategy"
...
Defines a phased transition from the prototype LocalPatternManager singleton to dependency-injected managers for PromptTemplates.
