...
| [Getting Started](/getting-started/index.md) | Table of contents for getting-started | 2025-12-08 | `docs/getting-started/index.md` |
...
| [User Guide](/user-guide/index.md) | Table of contents for user-guide | 2025-12-08 | `docs/user-guide/index.md` |
...
| Title | Description | Created | Path |
| --- | --- | --- | --- |
| [conceptual-architecture](/project/conceptual-architecture.md) |  |  | `docs/project/conceptual-architecture.md` |
| [future-directions](/project/future-directions.md) |  |  | `docs/project/future-directions.md` |
| [philosophy](/project/philosophy.md) |  |  | `docs/project/philosophy.md` |
| [principles](/project/principles.md) |  |  | `docs/project/principles.md` |
| [Project](/project/index.md) | Table of contents for project | 2025-12-08 | `docs/project/index.md` |
...
| [vision](/project/vision.md) |  |  | `docs/project/vision.md` |

## Community

| Title | Description | Created | Path |
| --- | --- | --- | --- |
| [Community & Outreach](/community/index.md) | Documentation for community partners, stakeholders, and collaborators in the Plum Village tradition. |  | `docs/community/index.md` |
| [parallax-overview](/community/parallax-overview.md) |  |  | `docs/community/parallax-overview.md` |
...
| [CLI Reference](/cli-reference/index.md) | Table of contents for cli-reference | 2025-12-08 | `docs/cli-reference/index.md` |
...
| Title | Description | Created | Path |
| --- | --- | --- | --- |
| [Adr](/architecture/ai-text-processing/adr/index.md) | Table of contents for architecture/ai-text-processing/adr | 2025-12-08 | `docs/architecture/ai-text-processing/adr/index.md` |
| [Adr](/architecture/object-service/adr/index.md) | Table of contents for architecture/object-service/adr | 2025-12-08 | `docs/architecture/object-service/adr/index.md` |
| [Adr](/architecture/video-processing/adr/index.md) | Table of contents for architecture/video-processing/adr | 2025-12-08 | `docs/architecture/video-processing/adr/index.md` |
| [Adr](/architecture/project-policies/adr/index.md) | Table of contents for architecture/project-policies/adr | 2025-12-08 | `docs/architecture/project-policies/adr/index.md` |
| [Adr](/architecture/gen-ai-service/adr/index.md) | Table of contents for architecture/gen-ai-service/adr | 2025-12-08 | `docs/architecture/gen-ai-service/adr/index.md` |
| [Adr](/architecture/transcription/adr/index.md) | Table of contents for architecture/transcription/adr | 2025-12-08 | `docs/architecture/transcription/adr/index.md` |
| [Adr](/architecture/prompt-system/adr/index.md) | Table of contents for architecture/prompt-system/adr | 2025-12-08 | `docs/architecture/prompt-system/adr/index.md` |
| [Adr](/architecture/prompt-system/archive/adr/index.md) | Table of contents for architecture/prompt-system/archive/adr | 2025-12-08 | `docs/architecture/prompt-system/archive/adr/index.md` |
| [Adr](/architecture/ytt-fetch/adr/index.md) | Table of contents for architecture/ytt-fetch/adr | 2025-12-08 | `docs/architecture/ytt-fetch/adr/index.md` |
| [Adr](/architecture/knowledge-base/adr/index.md) | Table of contents for architecture/knowledge-base/adr | 2025-12-08 | `docs/architecture/knowledge-base/adr/index.md` |
| [Adr](/architecture/tnh-gen/adr/index.md) | Table of contents for architecture/tnh-gen/adr | 2025-12-08 | `docs/architecture/tnh-gen/adr/index.md` |
| [Adr](/architecture/docs-system/adr/index.md) | Table of contents for architecture/docs-system/adr | 2025-12-08 | `docs/architecture/docs-system/adr/index.md` |
| [Adr](/architecture/metadata/adr/index.md) | Table of contents for architecture/metadata/adr | 2025-12-08 | `docs/architecture/metadata/adr/index.md` |
...
| [adr-dd03-phase1-punchlist](/architecture/docs-system/adr/adr-dd03-phase1-punchlist.md) |  |  | `docs/architecture/docs-system/adr/adr-dd03-phase1-punchlist.md` |
...
| [ADR-PT01: Pattern Access Strategy](/architecture/prompt-system/archive/adr/adr-pt01-pattern-access-strategy.md) | Introduces a two-phase plan for accessing PromptTemplate metadata, moving from a singleton to injected managers. | 2025-02-26 | `docs/architecture/prompt-system/archive/adr/adr-pt01-pattern-access-strategy.md` |
| [ADR-PT02: Adopt Pattern and PatternCatalog as Core Concepts](/architecture/prompt-system/archive/adr/adr-pt02-adopt-pattern-and-patterncatalog.md) | Keeps the Pattern terminology while clarifying how PatternCatalog functions in TNH Scholar. | 2025-09-22 | `docs/architecture/prompt-system/archive/adr/adr-pt02-adopt-pattern-and-patterncatalog.md` |
...
| [ADR-PT04: Prompt System Refactor Plan](/architecture/prompt-system/adr/adr-pt04-prompt-system-refactor.md) | Refactors the legacy pattern-based prompt system into a modular, object-service compliant PromptCatalog with validation, transport isolation, and clean dependency injection seams. | 2025-12-05 | `docs/architecture/prompt-system/adr/adr-pt04-prompt-system-refactor.md` |
...
| [adr-vsc01-vscode-integration-strategy](/architecture/ui-ux/vs-code-integration/adr-vsc01-vscode-integration-strategy.md) |  |  | `docs/architecture/ui-ux/vs-code-integration/adr-vsc01-vscode-integration-strategy.md` |
...
| [Ai Text Processing](/architecture/ai-text-processing/index.md) | Table of contents for architecture/ai-text-processing | 2025-12-08 | `docs/architecture/ai-text-processing/index.md` |
| [Architecture](/architecture/index.md) | Table of contents for architecture | 2025-12-08 | `docs/architecture/index.md` |
...
| [Archive](/architecture/prompt-system/archive/index.md) | Table of contents for architecture/prompt-system/archive | 2025-12-08 | `docs/architecture/prompt-system/archive/index.md` |
| [Archive](/architecture/tnh-gen/design/archive/index.md) | Table of contents for architecture/tnh-gen/design/archive | 2025-12-08 | `docs/architecture/tnh-gen/design/archive/index.md` |
...
| [Configuration](/architecture/configuration/index.md) | Table of contents for architecture/configuration | 2025-12-08 | `docs/architecture/configuration/index.md` |
| [Core Pattern Architecture: Meta-patterns, Textual Expansion Processing](/architecture/prompt-system/archive/core-pattern-architecture.md) | ```mermaid | 2025-02-26 | `docs/architecture/prompt-system/archive/core-pattern-architecture.md` |
| [Design](/architecture/ai-text-processing/design/index.md) | Table of contents for architecture/ai-text-processing/design | 2025-12-08 | `docs/architecture/ai-text-processing/design/index.md` |
| [Design](/architecture/gen-ai-service/design/index.md) | Table of contents for architecture/gen-ai-service/design | 2025-12-08 | `docs/architecture/gen-ai-service/design/index.md` |
| [Design](/architecture/transcription/design/index.md) | Table of contents for architecture/transcription/design | 2025-12-08 | `docs/architecture/transcription/design/index.md` |
| [Design](/architecture/setup-tnh/design/index.md) | Table of contents for architecture/setup-tnh/design | 2025-12-08 | `docs/architecture/setup-tnh/design/index.md` |
| [Design](/architecture/utilities/design/index.md) | Table of contents for architecture/utilities/design | 2025-12-08 | `docs/architecture/utilities/design/index.md` |
| [Design](/architecture/ytt-fetch/design/index.md) | Table of contents for architecture/ytt-fetch/design | 2025-12-08 | `docs/architecture/ytt-fetch/design/index.md` |
| [Design](/architecture/jvb-viewer/design/index.md) | Table of contents for architecture/jvb-viewer/design | 2025-12-08 | `docs/architecture/jvb-viewer/design/index.md` |
| [Design](/architecture/ui-ux/design/index.md) | Table of contents for architecture/ui-ux/design | 2025-12-08 | `docs/architecture/ui-ux/design/index.md` |
| [Design](/architecture/docs-system/design/index.md) | Table of contents for architecture/docs-system/design | 2025-12-08 | `docs/architecture/docs-system/design/index.md` |
...
| [Docs System](/architecture/docs-system/index.md) | Table of contents for architecture/docs-system | 2025-12-08 | `docs/architecture/docs-system/index.md` |
...
| [Gen Ai Service](/architecture/gen-ai-service/index.md) | Table of contents for architecture/gen-ai-service | 2025-12-08 | `docs/architecture/gen-ai-service/index.md` |
...
| [Jvb Viewer](/architecture/jvb-viewer/index.md) | Table of contents for architecture/jvb-viewer | 2025-12-08 | `docs/architecture/jvb-viewer/index.md` |
...
| [Knowledge Base](/architecture/knowledge-base/index.md) | Table of contents for architecture/knowledge-base | 2025-12-08 | `docs/architecture/knowledge-base/index.md` |
...
| [Metadata](/architecture/metadata/index.md) | Table of contents for architecture/metadata | 2025-12-08 | `docs/architecture/metadata/index.md` |
...
| [Object Service](/architecture/object-service/index.md) | Table of contents for architecture/object-service | 2025-12-08 | `docs/architecture/object-service/index.md` |
...
| [Prompt System](/architecture/prompt-system/index.md) | Table of contents for architecture/prompt-system | 2025-12-08 | `docs/architecture/prompt-system/index.md` |
...
| [Setup Tnh](/architecture/setup-tnh/index.md) | Table of contents for architecture/setup-tnh | 2025-12-08 | `docs/architecture/setup-tnh/index.md` |
...
| [TNH FAB Design Document](/architecture/tnh-gen/design/archive/tnh-fab-design-document.md) | First-generation design of the `tnh-fab` CLI covering core commands, usage patterns, and processing goals. | 2025-01-21 | `docs/architecture/tnh-gen/design/archive/tnh-fab-design-document.md` |
| [TNH-FAB Command Line Tool Specification](/architecture/tnh-gen/design/archive/tnh-fab-cli-spec.md) | Expanded specification for the `tnh-fab` CLI with refined command behaviors, options, and workflow integration. | 2025-01-21 | `docs/architecture/tnh-gen/design/archive/tnh-fab-cli-spec.md` |
| [TNH-Gen CLI](/architecture/tnh-gen/index.md) | Unified command-line interface for TNH Scholar GenAI operations | 2025-12-07 | `docs/architecture/tnh-gen/index.md` |
...
| [Transcription](/architecture/transcription/index.md) | Table of contents for architecture/transcription | 2025-12-08 | `docs/architecture/transcription/index.md` |
| [Ui Ux](/architecture/ui-ux/index.md) | Table of contents for architecture/ui-ux | 2025-12-08 | `docs/architecture/ui-ux/index.md` |
| [Utilities](/architecture/utilities/index.md) | Table of contents for architecture/utilities | 2025-12-08 | `docs/architecture/utilities/index.md` |
...
| [Video Processing](/architecture/video-processing/index.md) | Table of contents for architecture/video-processing | 2025-12-08 | `docs/architecture/video-processing/index.md` |
| [Vs Code Integration](/architecture/ui-ux/vs-code-integration/index.md) | Table of contents for architecture/ui-ux/vs-code-integration | 2025-12-08 | `docs/architecture/ui-ux/vs-code-integration/index.md` |
...
| [Ytt Fetch](/architecture/ytt-fetch/index.md) | Table of contents for architecture/ytt-fetch | 2025-12-08 | `docs/architecture/ytt-fetch/index.md` |
...
| [Docs Ops](/docs-ops/index.md) | Table of contents for docs-ops | 2025-12-08 | `docs/docs-ops/index.md` |
...
| [Gpt4O Search Query Testing](/research/gpt4o-search-query-testing/index.md) | Table of contents for research/gpt4o-search-query-testing | 2025-12-08 | `docs/research/gpt4o-search-query-testing/index.md` |
| [Gpt4O Translation Experiments](/research/gpt4o-translation-experiments/index.md) | Table of contents for research/gpt4o-translation-experiments | 2025-12-08 | `docs/research/gpt4o-translation-experiments/index.md` |
...
| [Research](/research/index.md) | Entry points to research notes, experiments, and feasibility studies. |  | `docs/research/index.md` |
...
| Title | Description | Created | Path |
| --- | --- | --- | --- |
| [TNH Scholar](/index.md) | Comprehensive documentation for TNH Scholar, an AI-driven project exploring, processing, and translating the teachings of Thich Nhat Hanh. |  | `docs/index.md` |

## Archive

| Title | Description | Created | Path |
| --- | --- | --- | --- |
| [Archive](/archive/index.md) | Table of contents for archive | 2025-12-08 | `docs/archive/index.md` |
