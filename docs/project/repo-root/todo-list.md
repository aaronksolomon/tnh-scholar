...
updated: '2026-04-26'
auto_generated: true
generated_from: /TODO.md
---

<!-- DO NOT EDIT: Auto-generated from /TODO.md. Edit the root file instead. -->
...
- **Context**: The maintained OA04.x runtime contracts now include the real OA07.1 worktree runtime boundary and the maintained headless entry path. Bootstrap is no longer blocked on substrate. The next blocker is proving one useful repo-native workflow through the maintained path. Follow [ADR-OA07](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/agent-orchestration/adr/adr-oa07-diff-policy-safety-rails.md) and [ADR-OA07.1](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/agent-orchestration/adr/adr-oa07.1-worktree-lifecycle-and-rollback.md).
- **Bootstrap Goal**:
...
- **Context**: OA04.2–OA04.5 are the contract-layer ADRs between the OA07 runtime foundations and the maintained runner/policy/provenance implementations. That contract family is now landed in code and should no longer be treated as pending. See implementation notes in [ADR-OA04.1 Addendum 2026-03-27](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/agent-orchestration/adr/adr-oa04.1-implementation-notes-mvp-buildout.md) for the original scaffolding gaps and [ADR-OA04.1 Addendum 2026-04-05](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/agent-orchestration/adr/adr-oa04.1-implementation-notes-mvp-buildout.md) for the bootstrap-first reprioritization.
- **Dependency chain**:
...
- **v1 As-Built**: [ADR-JVB01](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/jvb-viewer/adr/adr-jvb01_as-built_jvb_viewer_v1.md) — Browser-based prototype architecture
- **v2 Strategy (Draft)**: [JVB Viewer V2 Strategy](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/jvb-viewer/design/jvb-viewer-v2-strategy.md) — Pre-ADR strategy note (good foundations, needs formalization)
- **VS Code Platform Strategy**: [VS Code as UI Platform](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/ui-ux/design/vs-code-as-ui-platform.md) — Overall UI-UX direction
- **VS Code Integration**: [ADR-VSC01](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/ui-ux/vs-code-integration/adr-vsc01-vscode-integration-strategy.md) — CLI-first extension strategy (implemented)
...
- **ADR**: [ADR-TG01 Addendum 2026-01-02](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/tnh-gen/adr/adr-tg01-cli-architecture.md#addendum-2026-01-02---add---prompt-dir-global-flag)
...
- **Components Implemented**:
  - [x] [params_policy.py](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/config/params_policy.py) — Policy precedence implemented ✅
  ...
  - [x] [model_router.py](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/routing/model_router.py) — Capability-based routing implemented ✅
  ...
  - [x] [safety_gate.py](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/safety/safety_gate.py) — Three-layer safety checks implemented ✅
  ...
  - [x] [completion_mapper.py](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/mappers/completion_mapper.py) — Bi-directional mapping implemented ✅
...
- **High Priority (Before Merging)**:
  - [x] Add Google-style docstrings to public functions (see [style-guide.md](../../development/style-guide.md))
...
- **Medium Priority (V1 Completion)**:
  ...
  - [ ] Intent routing implementation
    ...
    - Current: placeholder at [model_router.py:98-101](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/routing/model_router.py#L98-L101)
  - [ ] Post-check safety implementation
    - Add content validation logic to `safety_gate.post_check()`
    - Current: stubbed at [safety_gate.py:124-133](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/safety/safety_gate.py#L124-L133)
...
- **Low Priority (Future Work)**:
  ...
  - [ ] **Message.content Type Architecture Investigation** (design quality, non-blocking)
    - **Location**: [gen_ai_service/models/domain.py:92-96](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/models/domain.py#L92-L96)
...
- **ADR**: [ADR-A15: Thread Safety and Rate Limiting](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/gen-ai-service/adr/adr-a15-thread-safety-rate-limiting.md)
...
- **ADR**: [ADR-OA03.2](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/agent-orchestration/adr/adr-oa03.2-codex-runner.md)
- **Why Tabled**:
...
- **Findings**: [Codex Harness Spike Findings](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/agent-orchestration/notes/codex-harness-spike-findings.md)
...
- **ADRs**:
  - [ADR-CF01: Runtime Context & Configuration Strategy](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/configuration/adr/adr-cf01-runtime-context-strategy.md)
  - [ADR-CF02: Prompt Catalog Discovery Strategy](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/configuration/adr/adr-cf02-prompt-catalog-discovery.md) (status: accepted)
- **Related**: [ADR-A08: Config/Params/Policy Taxonomy](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/gen-ai-service/adr/adr-a08-config-params-policy-taxonomy.md)
...
- **Location**: [cli_tools/audio_transcribe/](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/cli_tools/audio_transcribe/)
- **Tasks**:
...
- **Tasks**:
  ...
  - [x] Deprecate the external prompt-repo / setup-download path from the normative release workflow, or explicitly reclassify it as experimental-only per [ADR-PT05.1](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/prompt-system/adr/adr-pt05.1-prototype-prompt-workspace-simplification.md)
  ...
  - [ ] Follow up on the prompt-platform docs/ADR triage captured in [Prompt Platform Cleanup Follow-On](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/prompt-system/notes/prompt-platform-cleanup-follow-on-2026-05.md) after the current `tnh-gen` testing slice is stabilized
...
- **ADR**: [ADR-K01](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/knowledge-base/adr/adr-k01-kb-architecture-strategy.md)
- **Tasks**:
...
- **ADR**: [ADR-ST01.1: tnh-setup UI Design](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/setup-tnh/adr/adr-st01.1-tnh-setup-ui-design.md)
...
- **Status**: NOT STARTED
- **Tasks**:
  - [ ] Implement [Anthropic adapter](https://github.com/aaronksolomon/tnh-scholar/blob/main/src/tnh_scholar/gen_ai_service/providers/anthropic_adapter.py)
...
- **ADR**: [ADR-TG01](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/tnh-gen/adr/adr-tg01-cli-architecture.md), [ADR-TG01.1](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/tnh-gen/adr/adr-tg01.1-human-friendly-defaults.md)
- **What**: Protocol-driven CLI replacing tnh-fab, dual modes (human-friendly default, `--api` for machine consumption)
- **Documentation**: [tnh-gen CLI Reference](https://github.com/aaronksolomon/tnh-scholar/blob/main/cli-reference/tnh-gen.md) (661 lines)

<a id="file-based-registry-system-adr-a14-"></a>
### File-Based Registry System (ADR-A14) ✅

- **Completed**: 2026-01-01 (PR #24)
- **ADR**: [ADR-A14](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/gen-ai-service/adr/adr-a14-file-based-registry-system.md), [ADR-A14.1](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/gen-ai-service/adr/adr-a14.1-registry-staleness-detection.md)
...
- **ADR**: [ADR-VSC01](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/ui-ux/vs-code-integration/adr-vsc01-vscode-integration-strategy.md), [ADR-VSC02](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/ui-ux/vs-code-integration/adr-vsc02-tnh-gen-cli-implementation.md)
...
- **ADR**: [ADR-PT04](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/prompt-system/adr/adr-pt04-prompt-system-refactor.md)
...
- **Completed**: 2026-01-19
- **ADR**: [ADR-TG01 Addendum 2025-12-28](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/tnh-gen/adr/adr-tg01-cli-architecture.md#addendum-2025-12-28---provenance-format-standardization)
...
- **ADR**: [ADR-A13](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/gen-ai-service/adr/adr-a13-migrate-openai-to-genaiservice.md)
...
- **ADR**: [ADR-DD01](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/docs-system/adr/adr-dd01-docs-reorg-strategy.md), [ADR-DD02](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/docs-system/adr/adr-dd02-main-content-nav.md)
...
- **ADR**: [ADR-AT03.2](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/ai-text-processing/adr/adr-at03.2-numberedtext-validation.md) (status: accepted → should be implemented)
...
- **ADR**: [ADR-AT03.3](https://github.com/aaronksolomon/tnh-scholar/blob/main/architecture/ai-text-processing/adr/adr-at03.3-textobject-robustness.md) (status: accepted → should be implemented)
