...
description: Versioning policy for TNH Scholar during rapid prototype phase (0.x)
  and post-1.0 stable releases
status: current
created: '2025-12-06'
auto_generated: true
generated_from: /VERSIONING.md
owner: Documentation Working Group
author: Docs Automation
---

<!-- DO NOT EDIT: Auto-generated from /VERSIONING.md. Edit the root file instead. -->
...
- [CHANGELOG.md](https://github.com/aaronksolomon/tnh-scholar/blob/main/CHANGELOG.md) - Detailed version history
- [CONTRIBUTING.md](https://github.com/aaronksolomon/tnh-scholar/blob/main/CONTRIBUTING.md) - Contribution guidelines
- [release_checklist.md](https://github.com/aaronksolomon/tnh-scholar/blob/main/release_checklist.md) - Release process
- [ADR-PT04](../../architecture/prompt-system/adr/adr-pt04-prompt-system-refactor.md) - Example breaking change (prompt system refactor)
