...
description: TNH Scholar is rapidly evolving, but we strive for a predictable, reproducible
...
created: '2024-10-21'
auto_generated: true
generated_from: /CONTRIBUTING.md
---

<!-- DO NOT EDIT: Auto-generated from /CONTRIBUTING.md. Edit the root file instead. -->
...
Follow [DEV_SETUP.md](https://github.com/aaronksolomon/tnh-scholar/blob/main/DEV_SETUP.md) for detailed instructions. The essentials are:
...
- When committing changes, group related modifications together in logical commits.
...
If you get stuck during setup, consult [DEV_SETUP.md](https://github.com/aaronksolomon/tnh-scholar/blob/main/DEV_SETUP.md) first — it is the canonical source for environment instructions.  
