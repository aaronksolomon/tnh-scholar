---
title: "Gpt4O Search Query Testing"
...
**[1-3 Word Queries](queries-1-3-words.md)** - Prompt experiments for generating search query and passage pairs used to train retrieval models.
