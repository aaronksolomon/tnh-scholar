...
*This document is a pipeline-assisted translation produced by `tnh-gen`, part of the
`tnh-scholar` suite, using the `translate_journal_section_tnh_voice_en` prompt against
cleaned OCR text from a five-page extracted scan subset. It is offered as a research
baseline and working draft, not a final translation.*
